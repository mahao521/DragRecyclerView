...
import com.qianmo.dragrecyclerview.adapter.CardItemAdapter;
  ...
  public boolean onTouchEvent(MotionEvent e) {
    ...
    switch (e.getAction()) {
      case MotionEvent.ACTION_DOWN:
        ...
        if (item != null) {
          //获取当前选中的Item
          ViewHolder childViewHolder = getChildViewHolder(item);
          if (childViewHolder instanceof CardItemAdapter.ViewHolder) {
            CardItemAdapter.ViewHolder viewHolder = (CardItemAdapter.ViewHolder) childViewHolder;
          } else {
            CategroyItemAdapter.ViewHolder viewHolder = (CategroyItemAdapter.ViewHolder) childViewHolder;
          }
          //找到具体元素（这与实际业务相关了~~）
